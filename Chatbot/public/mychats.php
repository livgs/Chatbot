...
try {
    ...
    // Logg teknisk feil, men ikke vis detaljer til bruker
    error_log('[mychats] Feil ved henting av chatter: ' . $exception->getMessage());
    $sessions  = [];
    $loadError = true;
}
?>
...
<?php if (!empty($loadError)): ?>
    <div class="empty">
        <p>Det oppstod en feil ved henting av chatter. Prøv igjen senere.</p>
    </div>
